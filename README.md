...
**HACS 0.15.15 — jeden adaptacyjny panel Szkoła, własne zajęcia, A4, frekwencja z legendą, modułowy pulpit i potwierdzane odpowiedzi przez mojV Auth Helper 0.2.0.**
...
W HACS 0.15.15 obsługiwane są rzeczywiste dane:
...
Przy starcie integracji HACS 0.15.15 w logu powinien pojawić się wpis:

`mojV integration version=0.15.15`
