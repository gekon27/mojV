...
if (proto && !proto.__mojvDetailUxPatched) {
  ...
  proto._styles = function () {
    return `${baseStyles.call(this)}
      .schoolwork-card{max-width:min(1220px,100%)}.work-list{padding:10px 22px 18px}.work-row.mojv-detail-trigger{width:100%;min-height:130px;border:0;border-bottom:1px solid var(--mv-line);border-radius:0;background:transparent;color:inherit;text-align:left;cursor:pointer;padding:14px 0}.work-row.mojv-detail-trigger:last-child{border-bottom:0}.work-row.mojv-detail-trigger:hover,.work-row.mojv-detail-trigger:focus-visible{background:color-mix(in srgb,var(--mv-accent) 7%,transparent);outline:none}.work-row.mojv-detail-trigger .work-date,.work-row.mojv-detail-trigger .work-copy,.work-row.mojv-detail-trigger .due-pill{display:block}.work-row.mojv-detail-trigger .work-date{width:54px;height:62px}.work-row.mojv-detail-trigger .work-date strong{font-size:22px}.work-row.mojv-detail-trigger .work-date span{font-size:10px}.work-row.mojv-detail-trigger .work-copy>span:first-child{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.work-row.mojv-detail-trigger .work-copy strong{font-size:15px}.work-row.mojv-detail-trigger .work-copy>span,.work-row.mojv-detail-trigger .work-copy p,.work-row.mojv-detail-trigger .work-meta-line{font-size:12px}.work-row.mojv-detail-trigger .work-kind{font-size:9px!important}.work-row.mojv-detail-trigger .due-pill{padding:6px 10px;font-size:10.5px}.work-meta-line{margin-top:5px!important;white-space:normal!important;line-height:1.45}.work-meta-line b,.work-copy p b{color:var(--primary-text-color,#fff);font-weight:700}.mojv-preview-empty{font-style:italic}
