import "./school-panel-hub-base.js?v=0.15.15";
...
if (proto && !proto.__mojvDetailUxPatched) {
  ...
  proto._styles = function () {
    return `${baseStyles.call(this)}
      .schoolwork-card{max-width:none}.work-list{padding:14px 26px 22px}.work-row.mojv-detail-trigger{width:100%;min-height:150px;border:0;border-bottom:1px solid var(--mv-line);border-radius:0;background:transparent;color:inherit;text-align:left;cursor:pointer;padding:18px 0}.work-row.mojv-detail-trigger:last-child{border-bottom:0}.work-row.mojv-detail-trigger:hover,.work-row.mojv-detail-trigger:focus-visible{background:color-mix(in srgb,var(--mv-accent) 7%,transparent);outline:none}.work-row.mojv-detail-trigger .work-date,.work-row.mojv-detail-trigger .work-copy,.work-row.mojv-detail-trigger .due-pill{display:block}.work-row.mojv-detail-trigger .work-date{width:60px;height:68px}.work-row.mojv-detail-trigger .work-date strong{font-size:25px}.work-row.mojv-detail-trigger .work-date span{font-size:11px}.work-row.mojv-detail-trigger .work-copy>span:first-child{display:flex;align-items:center;gap:9px;flex-wrap:wrap}.work-row.mojv-detail-trigger .work-copy strong{font-size:17px;line-height:1.35}.work-row.mojv-detail-trigger .work-copy>span,.work-row.mojv-detail-trigger .work-copy p,.work-row.mojv-detail-trigger .work-meta-line{font-size:14px}.work-row.mojv-detail-trigger .work-kind{font-size:10px!important}.work-row.mojv-detail-trigger .due-pill{padding:7px 11px;font-size:12px}.work-meta-line{margin-top:7px!important;white-space:normal!important;line-height:1.5}.work-copy p{line-height:1.55!important}.work-meta-line b,.work-copy p b{color:var(--primary-text-color,#fff);font-weight:700}.mojv-preview-empty{font-style:italic}
