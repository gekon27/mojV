...
if (proto && !proto.__mojvExpandedSchoolHubPatched) {
  ...
  proto._renderDashboard = function (student) {
    ...
    if (students.length <= 1) return this._renderDashboardForStudent(student);
